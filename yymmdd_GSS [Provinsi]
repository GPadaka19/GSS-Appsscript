function createAndRenameSheets() {
  ...
  var sheetsData = [
    ...
    { name: "Room Website D", filterValue: "Room Website D", headerColumns: ["A1:I1", "M1"]},
    { name: "Room Website E", filterValue: "Room Website E", headerColumns: ["A1:I1", "N1"]},
    { name: "Room Instagram A", filterValue: "Room Instagram A", headerColumns: ["A1:I1", "O1"]},
    { name: "Room Instagram B", filterValue: "Room Instagram B", headerColumns: ["A1:I1", "P1"]},
    { name: "Room Instagram C", filterValue: "Room Instagram C", headerColumns: ["A1:I1", "Q1"]},
    { name: "Room Instagram D", filterValue: "Room Instagram D", headerColumns: ["A1:I1", "R1"]},
    { name: "Room Tiktok A", filterValue: "Room Tiktok A", headerColumns: ["A1:I1", "S1"]},
    { name: "Room Tiktok B", filterValue: "Room Tiktok B", headerColumns: ["A1:I1", "T1",]},
    { name: "Room Tiktok C", filterValue: "Room Tiktok C", headerColumns: ["A1:I1", "U1",]},
    { name: "Room Tiktok D", filterValue: "Room Tiktok D", headerColumns: ["A1:I1", "V1"]},
  ];
  ...
  for (var i = 0; i < sheetsData.length; i++) {
    ...
    range.setFormula('=FILTER(Master!A:V;Master!I:I="' + filterValue + '")'); // Set rumus pada cell A2
