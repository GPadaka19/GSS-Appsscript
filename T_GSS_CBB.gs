function createAndRenameSheets() {
  ...
  var sheetsData = [
    { name: "Room Website A", filterValue: "Room Website A", headerColumns: ["A1:H1"] },
    { name: "Room Website B", filterValue: "Room Website B", headerColumns: ["A1:G1", "I1"] },
    { name: "Room Website C", filterValue: "Room Website C", headerColumns: ["A1:G1", "J1"] },
    { name: "Room Instagram A", filterValue: "Room Instagram A", headerColumns: ["A1:G1", "K1"] },
    { name: "Room Instagram B", filterValue: "Room Instagram B", headerColumns: ["A1:G1", "L1"] },
    { name: "Room Tiktok A", filterValue: "Room Tiktok A", headerColumns: ["A1:G1", "M1"] },
    { name: "Room Tiktok B", filterValue: "Room Tiktok B", headerColumns: ["A1:G1", "N1"] },
  ];
  ...
  for (var i = 0; i < sheetsData.length; i++) {
    ...
    var headerRange = newSheet.getRange("A1:N1"); // Anggap header berada di kolom A hingga V
